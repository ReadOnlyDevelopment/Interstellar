...
package com.readonlydev.lib.client.gui.element.container.list;
...
public abstract class SContListV extends SContainerDynamic {
  public SContListV(String elementID) {
    super(elementID);
  }
  ...
  public void postInitPositioning() {
    ...
    for (SElement vlElement : this.elements) {
      vlElement.setYPosOffset(yS);
      yS = vlElement.getYPosOffsetLargest();
    } 
  }
