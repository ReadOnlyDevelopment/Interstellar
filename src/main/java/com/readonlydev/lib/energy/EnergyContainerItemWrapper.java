...
/**
 * This class provides a simple way to wrap an IEnergyContainerItem to allow for
 * capability support. It will seamlessly allow for Forge Energy to be supported
 * in addition to RF.
 *
 * @author King Lemming
 */
public class EnergyContainerItemWrapper implements ICapabilityProvider {
	...
	public EnergyContainerItemWrapper(ItemStack stackIn, IEnergyContainerItem containerIn, boolean extractIn,
			boolean receiveIn) {
