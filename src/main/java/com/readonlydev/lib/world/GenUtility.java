...
import com.readonlydev.lib.world.gen.structure.StructTemplate;
...
public class GenUtility {
	 ...
	 * Generates a generator n times in a chunk
	 */
	public static void generateN(World worldIn, Random rand, BlockPos pos, int n, int baseY, WorldGenerator gen) {
		for (int i = 0; i < n; ++i) {
			int x = rand.nextInt(16) + 8;
	...
	public static int getGroundHeight(StructTemplate template, IChunkGen gen, Rotation rotation) {
