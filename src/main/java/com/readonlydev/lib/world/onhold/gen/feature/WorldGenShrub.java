...
//
//class WorldGenShrub extends WorldGenerator {
//
//	private int varSize;
...
//
//	public WorldGenShrub(int size, IBlockState log, IBlockState leav, boolean sand) {
//
//		varSize = size;
//		varSand = sand;
//		logBlock = log;
...
//
//		if ((b == Blocks.SAND.getDefaultState() || b1 == Blocks.SAND.getDefaultState())) {
//			return;
//		}
//
//		if (b.getMaterial() == Material.GRASS || b.getMaterial() == Material.GROUND
//				|| (varSand && b.getMaterial() == Material.SAND)) {
