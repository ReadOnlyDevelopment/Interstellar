...
//		if (!world.isRemote) {
//			Interstellar.log.debug("WorldEvent.Load: WorldType: {}, DimID: {}, DimType: {}, BiomeProvider: {}, IChunkGenerator: {}", world.getWorldType().getClass().getSimpleName(), world.provider.getDimension(), world.provider.getDimensionType(),
//					world.provider.getBiomeProvider().getClass().getName(), ((ChunkProviderServer) world.getChunkProvider()).chunkGenerator.getClass().getName());
...
//		if (!world.isRemote) {
//			Interstellar.log.debug("WorldEvent.Unload: WorldType: {}, DimID: {}, DimType: {}, BiomeProvider: {}, IChunkGenerator: {}", world.getWorldType().getClass().getSimpleName(), world.provider.getDimension(), world.provider.getDimensionType(),
//					world.provider.getBiomeProvider().getClass().getName(), ((ChunkProviderServer) world.getChunkProvider()).chunkGenerator.getClass().getName());
//		}
