...
//import com.readonlydev.lib.world.gen.feature.WorldGenPond;
//import com.readonlydev.lib.world.onhold.gen.ExoChunkGenSettings;
//import com.readonlydev.lib.world.onhold.noise.ExoplanetWorld;
//import com.readonlydev.lib.world.onhold.noise.ISimplexData2D;
//import com.readonlydev.lib.world.onhold.noise.LimitedArrayCacheMap;
...
//
//class ChunkGenerator implements IChunkGen {
//
...
//
//		Interstellar.log.debug("Instantiating CPRTG using generator settings: {}", exoWorld.world().getWorldInfo().getGeneratorOptions());
//
...
//	}
//
//	private void replaceBiomeBlocks(int cx, int cz, ChunkPrimer primer, IExoplanetBiome[] biomes, Biome[] base, float[] noise) {
...
//				int depth = -1;
//				biomes[x * 16 + z].rReplace(primer, mpos, x, z, depth, exoWorld, noise, 0/* river */, base);
...
//			WorldEntitySpawner.performWorldGenSpawning(this.world, biome.getBiome(), blockPos.getX() + 8, blockPos.getZ() + 8, 16, 16, this.rand);
//		}
...
//				landscape.river[x * 16 + z] = -0/* river */;
//				for (int i = 0; i < 256; i++) {
//					if (weightedBiomes[i] > 0f) {
//						landscape.noise[x * 16 + z] += InterstellarAPI.getBiome(i).rNoise(this.exoWorld, worldX + x, worldZ + z, weightedBiomes[i], river + 1f) * weightedBiomes[i];
//
//						weightedBiomes[i] = 0f;
//					}
//				}
