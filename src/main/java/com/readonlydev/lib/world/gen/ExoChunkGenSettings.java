package com.readonlydev.lib.world.gen;
...
public final class ExoChunkGenSettings {
	...
	// net.minecraft.world.gen.layer.GenLayerBiome for this to work.
...
//      this.snowDuneHeight         = settingsFactory.snowDuneHeight;
	...
	public static class Factory {
		...
		static final Gson JSON_ADAPTER = (new GsonBuilder())
				.registerTypeAdapter(ExoChunkGenSettings.Factory.class, new ExoChunkGenSettings.Serializer()).create();
