...
public abstract class BlockInterstellarTile extends BlockInterstellar implements ITileEntityProvider {

	public BlockInterstellarTile(Material material) {
		super(material);
	...
	public void dropEntireInventory(World worldIn, BlockPos pos, IBlockState state) {
		...
		if (tileEntity != null) {
			if (tileEntity instanceof IInventory) {
				...
				Random syncRandom = MathUtil.getRandom(pos);
