...
package net.interstellar.lib.registry;
...
import net.interstellar.api.block.IBlockTileEntity;
import net.interstellar.api.block.IModelProvider;
import net.interstellar.api.item.IMeshProvider;
import net.interstellar.api.registry.IInitProcessor;
import net.interstellar.api.repcie.IRecipeProcessor;
import net.interstellar.lib.block.BlockSubtype;
import net.interstellar.lib.item.ItemBlockSubtype;
import net.interstellar.lib.recipe.RecipeBuilder;
...
public class InterstellarRegistry {
	...
	/**
	 * Adds a function that will be called when it is time to register objects for a certain class. For example, adding a handler for class {@link Item} will call the function during {@link RegistryEvent.Register} for type {@link Item}.
	 * <p>
	 ...
	 */
	public <T extends Block & IFluidBlock> Fluid registerFluid(Fluid fluid, Function<Fluid, T> blockFactory) {
		fluids.add(fluid);
		FluidRegistry.registerFluid(fluid);
		FluidRegistry.addBucketForFluid(fluid);
		registerBlock(blockFactory.apply(fluid), "fluid_" + fluid.getName());
		return fluid;
	}
