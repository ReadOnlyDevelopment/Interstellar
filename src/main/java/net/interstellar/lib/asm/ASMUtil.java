...
package net.interstellar.lib.asm;
...
public class ASMUtil {
	...
	public static Field changeFieldAccess(Class<?> clazz, String fieldName, String srgName, boolean silenced) {
		try {
			...
			if (!silenced) {
				InterstellarLogger.error("Could not change access for field " + clazz.getSimpleName() + "." + (Interstellar.inObfEnv ? srgName : fieldName), e);
			}
			return null;
		}
	...
	public static Method changeMethodAccess(Class<?> clazz, String methodName, String srgName, boolean silenced, Class<?>... params) {
		try {
			...
			InterstellarLogger.error("Could not change access for method " + clazz.getSimpleName() + "." + (Interstellar.inObfEnv ? srgName : methodName), e);
		}
