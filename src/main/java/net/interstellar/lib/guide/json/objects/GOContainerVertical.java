...
import net.interstellar.lib.client.gui.element.container.list.SContListV;
...
import net.interstellar.lib.utils.factory.ConditionalFactory;
...
public class GOContainerVertical extends GuideObject {
	...
	public void initElement(String baseAddress, SElementContainerBase cont) {
		...
		cont.addElement(new SContListV(ba) {
			@Override
